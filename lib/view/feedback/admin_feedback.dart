...
class AdminFeedback extends StatelessWidget {
              ...
              return Padding(
                ...
                child: Column(
                  children: snapshot.data!.docs.map((doc){
                    FeedbackModel feedbackModel = FeedbackModel.fromJson(doc.data());
  ...
  Widget feedbackContainer({required FeedbackModel feedback}){
    String formatedDate = DateFormat('dd-MMM-yyy\nh:mm a')
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text("ID: ${feedback.studentId}", style: TextStyle(fontWeight: FontWeight.bold)),
              Spacer(),
              Text(formatedDate, style: TextStyle(color: Colors.grey)),
            ],
          ),
          SizedBox(height: 8),
          Text("Feedback:\n ${feedback.feedbackText}", style: TextStyle(fontSize: 16)),
        ],
      ),
    );
  }
